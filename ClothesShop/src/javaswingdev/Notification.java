...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaswingdev/error.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaswingdev/error.png"))); // NOI18N
